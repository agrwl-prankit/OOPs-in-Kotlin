...
/*
    ...
    if it does, the class is obliged to provide implementations of the properties
    and functions of the interface.

    However, an interface may (but typically doesn't) provide a default implementation of some or all
    of its properties and functions. If a property or function has a default implementation,
    the class may choose to override it, but it doesn't have to.
*/
...
open class Car7(override val maxSpeed: Double, open val brandName: String) : Driveable {
...
class ElectricCar(override val maxSpeed: Double, override val brandName: String,
                      batteryLife: Double) : Car7(maxSpeed, brandName) {
...
/*
    Subclasses of a class that implements an interface (in this case, ElectricCar) are also considered
